...
//
////        user4.getCredentials().getUsername();
//
//        // Profile
...
//        tweet1.setHashtagsOnThisTweet(Arrays.asList(hashtag1, hashtag2));
//        tweet1.setUsersMentionedByThisTweet(Arrays.asList(user1, user2));
...
//        tweet2.setHashtagsOnThisTweet(Arrays.asList(hashtag1, hashtag2));
...
//        tweet3.setHashtagsOnThisTweet(Arrays.asList(hashtag3, hashtag4));
...
//        tweet5.setUsersMentionedByThisTweet(Arrays.asList(user1, user2));
...
//        tweet6.setUsersMentionedByThisTweet(Arrays.asList(user1, user2));
...
//        deletedTweet.setUsersMentionedByThisTweet(Arrays.asList(user1, user2));
//        tweetRepository.saveAndFlush(deletedTweet);
//
//        // ----- LIST of Tweets + Adding to User# -----
//        List<Tweet> user1Tweets = List.of(tweet1, tweet2);
//        user1.setAuthoredTweets(user1Tweets);
//        userRepository.saveAndFlush(user1);
//
//        List<Tweet> user2Tweets = List.of(tweet3, tweet4);
//        user2.setAuthoredTweets(user2Tweets);
//        userRepository.saveAndFlush(user2);
//
//        List<Tweet> user3Tweets = List.of(tweet5, tweet6);
//        user3.setAuthoredTweets(user3Tweets);
//        userRepository.saveAndFlush(user3);
//
//        // ----- List of Liked Tweets -----
//        user1.setUserLikedTweets(user3Tweets);
//        userRepository.saveAndFlush(user1);
//
//        user2.setUserLikedTweets(user1Tweets);
//        user2.setUserLikedTweets(user2Tweets);
//        userRepository.saveAndFlush(user2);
//
//        user3.setUserLikedTweets(user2Tweets);
//        userRepository.saveAndFlush(user3);
//
//        deletedUser.setUserLikedTweets(user2Tweets);
